...
internal class AzureServiceBusResourceQueryService : IAzureServiceBusResourceQueryService
{
	...
	public async Task<long> GetMessageCount(ServiceBusResource selectedResource, CancellationToken cancellationToken)
	{
	...
	public async Task<MessageHandler> DownloadFullResource(ServiceBusResource selectedResource, CancellationToken cancellationToken)
	{
	...
	/// </summary>
	private async Task<MessageHandler> GetResourceResults(ServiceBusResource selectedResource, ServiceBusClient client, CancellationToken cancellationToken)
	{
