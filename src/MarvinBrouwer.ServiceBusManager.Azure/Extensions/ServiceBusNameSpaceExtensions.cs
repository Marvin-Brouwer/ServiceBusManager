...
internal static class ServiceBusNameSpaceExtensions
{
	...
	/// </summary>
	public static async Task<string> GetAccessConnectionString(
		this IServiceBusNamespace serviceBusNamespace, AccessRights accessRights, CancellationToken cancellationToken)
	{
